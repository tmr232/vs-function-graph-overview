...
namespace FunctionGraphOverview
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class FunctionGraphToolWindowCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("75d880a5-212f-4e69-8d86-b3e040019ccb");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionGraphToolWindowCommand"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in FunctionGraphToolWindowCommand's constructor requires
            // the UI thread.
